/* Lab 8, Part B: Created by Celine Latulipe  */  
public class Lab8PartB {   
  ...
  {     
    ...
    // call copy method to copy pixels from source into pic
    pic.copyPixelsFromSource(source);
    ...
    String outfilename = SimplePicture.getMediaPath("Lab8PartB.jpg");
    if (args.length > 2) {
