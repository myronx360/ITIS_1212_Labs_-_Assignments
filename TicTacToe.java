...
public class TicTacToe {
  ...
  public static void main(String[] args) throws InterruptedException
  {
    ...
    if (first == 0)
    {
      ...
      while (!winnerFound)
      {
        ...
        //Make sure that the comp turtle pen is up
        comp.penUp();
        switch (compChoice)
        {
          case 0:
  ...
  public static void computerMark()
  {
    ...
    //Boxes 0&1 = 2
    if (boxesTaken[0][0] == 1 && boxesTaken[0][1] == 1)
    {
      compChoice = 2;
    }
    
    //Boxes 0&3 = 6
    else if (boxesTaken[0][0] == 1 && boxesTaken[1][0] == 1)
    {
      compChoice = 6;
    }
    
    //Boxes 0&2 = 1
    else if (boxesTaken[0][0] == 1 && boxesTaken[0][2] == 1)
    {
      compChoice = 1;
    }
    
    //Boxes 0&6 = 3
    else if (boxesTaken[0][0] == 1 && boxesTaken[2][0] == 1)
    {
      compChoice = 3;
    }
    
    //Boxes 2&1 = 0
    else if (boxesTaken[0][2] == 1 && boxesTaken[0][1] == 1)
    {
      compChoice = 0;
    }
    
    //Boxes 2&5 = 8
    else if (boxesTaken[0][2] == 1 && boxesTaken[1][2] == 1)
    {
      compChoice = 8;
    }
    
    //Boxes 2&8 = 5
    else if (boxesTaken[0][2] == 1 && boxesTaken[2][2] == 1)
    {
      compChoice = 5;
    }
    
    //Boxes 2&4 = 6
    else if (boxesTaken[0][2] == 1 && boxesTaken[1][1] == 1)
    {
      compChoice = 6;
    }
    
    //Boxes 0&4 = 8
    else if (boxesTaken[0][0] == 1 && boxesTaken[1][1] == 1)
    {
      compChoice = 8;
    }
    
    //Boxes 8&5 = 2
    else if (boxesTaken[2][2] == 1 && boxesTaken[1][2] == 1)
    {
      compChoice = 2;
    }
    
    //Boxes 8&7 = 6
    else if (boxesTaken[2][2] == 1 && boxesTaken[2][1] == 1)
    {
      compChoice = 6;
    }
    
    //Boxes 8&6 = 7
    else if (boxesTaken[2][2] == 1 && boxesTaken[2][0] == 1)
    {
      compChoice = 7;
    }
    
    //Boxes 6&7 = 8
    else if (boxesTaken[2][0] == 1 && boxesTaken[2][1] == 1)
    {
      compChoice = 8;
    }
    
    //Boxes 6&3 = 1
    else if (boxesTaken[2][0] == 1 && boxesTaken[1][0] == 1)
    {
      compChoice = 1;
    }
    
    //Boxes 4&6 = 2
    else if (boxesTaken[1][1] == 1 && boxesTaken[2][0] == 1)
    {
      compChoice = 2;
    }
    
    //Boxes 4&8 = 0
    else if (boxesTaken[1][1] == 1 && boxesTaken[2][2] == 1)
    {
      compChoice = 0;
    }
    ...
    A:  for (int i = 0; i < boxesTaken.length; i++)
    {
      for (int j = 0; j < boxesTaken[i].length; j++)
      {
        ...
        if(boxesTaken[0][2] == 1 && boxesTaken[1][1] == 1 && boxesTaken[2][0] == 1) // diagonally 2
        {
          ...
          winnerFound = true;
          t.penUp();
          t.moveTo((int)(WORLD_WIDTH * 0.2), (int)(WORLD_HEIGHT * 0.8));
          animateLine(t, (45), (int)(WORLD_WIDTH * 0.2), (int)(WORLD_HEIGHT * 0.8),
                      (int)(WORLD_WIDTH * 0.8), (int)(WORLD_HEIGHT * 0.2));
          break A;
        }
